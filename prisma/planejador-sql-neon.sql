...
INSERT INTO "atrativo" (
  "id", "nome", "precoAdultoCents", "precoCriancaCents",
  "duracaoMediaHoras", "tempoDeslocamentoMedioHoras", "regiao", "nivelCansaco",
  "custoTransporteMedioCents", "exigeDocumento", "ativo", "ordem", "createdAt", "updatedAt"
) VALUES
  ('atr_cataratas_br', 'Cataratas Brasil', 8500, 4500, 4, 0.5, 'Cataratas Brasil', 'medio', 8000, false, true, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('atr_cataratas_arg', 'Cataratas Argentina', 12000, 6000, 5, 1.5, 'Argentina', 'intenso', 15000, true, true, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('atr_parque_aves', 'Parque das Aves', 8500, 4500, 2.5, 0.5, 'Cataratas Brasil', 'leve', 6000, false, true, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('atr_itaipu_panoramica', 'Itaipu Panorâmica', 5500, 2800, 2.5, 0.5, 'Itaipu', 'leve', 7000, false, true, 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('atr_itaipu_especial', 'Itaipu Especial', 18000, 9000, 4, 0.5, 'Itaipu', 'medio', 7000, false, true, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('atr_marco_3fronteiras', 'Marco das 3 Fronteiras', 4500, 2300, 2, 0.3, 'Centro', 'leve', 4000, false, true, 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('atr_museu_cera', 'Museu de Cera', 6000, 3500, 1.5, 0.2, 'Centro', 'leve', 3000, false, true, 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('atr_vale_dinossauros', 'Vale dos Dinossauros', 5500, 4500, 2, 0.3, 'Centro', 'leve', 4000, false, true, 8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('atr_bar_gelo', 'Bar de Gelo', 12000, 0, 1, 0.2, 'Centro', 'leve', 3000, false, true, 9, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('atr_compras_paraguai', 'Compras no Paraguai', 0, 0, 6, 1.5, 'Paraguai', 'medio', 25000, true, true, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('atr_city_tour', 'City Tour', 8000, 4000, 4, 0, 'Centro', 'leve', 0, false, true, 11, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('atr_passeio_barco', 'Passeio de Barco', 15000, 7500, 2, 0.5, 'Cataratas Brasil', 'leve', 8000, false, true, 12, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
