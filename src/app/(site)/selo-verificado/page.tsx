      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 md:p-12 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="flex items-start gap-4 p-4 rounded-xl bg-cyan-50/50 hover:bg-cyan-50 transition-colors">
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-3xl shadow-xl p-8 md:p-12 text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-4 bg-white text-blue-600 rounded-xl font-semibold text-lg hover:bg-gray-50 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
